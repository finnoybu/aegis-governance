...
ATX-1 organizes 29 techniques under 10 tactics, grouped by attack surface. Table~\ref{tab:atx1} summarizes the taxonomy with root cause mappings. The current release (v2.2) additionally catalogs 29 sub-techniques under T9002 and T10001--T10004, documenting specific bypass methods discovered during adversarial testing of the reference implementation; these sub-techniques refine the parent technique definitions without altering the tactic structure.
...
K.~Tannenbaum, ``ATX-1 v2.2: AEGIS Threat Matrix for Agentic AI Systems,'' IEEE DataPort, 2026. DOI:~10.21227/7c9p-6150.
